...
def main(
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ConvertImages$Float32":
                out = ij.op().convert().float32(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main", description="Converts the input image to a 32 bit float"
    )
