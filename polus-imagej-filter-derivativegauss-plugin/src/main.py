...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main",
        description="Performs the 2-D partial derivative Gaussian kernel convolutions on an image at a particular point.",
    )
    ...
    parser.add_argument(
        ...
        dest="in2",
        type=str,
        help="An array of numbers specifying the nth partial derivatives to compute",
        required=False,
    )
    parser.add_argument(
        "--sigma",
        dest="sigma",
        type=str,
        help="Standard deviation of the partial derivative Gaussian kernel",
        required=False,
    )
